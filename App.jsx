  ...
  <footer style={{background:B.black,padding:"20px 0 24px"}}><W>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:32,marginBottom:32}}>
      <div>
        ...
        <div style={{display:"flex",gap:8,flexWrap:"wrap"}}><a href="mailto:sam@eightbyzero.com" style={{fontFamily:F.m,fontSize:10,color:B.g,padding:"4px 10px",border:`1px solid ${B.gB}`,borderRadius:4}}>sam@eightbyzero.com</a><a href="https://eightbyzero.com" target="_blank" rel="noopener noreferrer" style={{fontFamily:F.m,fontSize:10,color:B.dm,padding:"4px 10px",border:`1px solid ${B.bdr}`,borderRadius:4}}>eightbyzero.com</a></div>
      </div>
